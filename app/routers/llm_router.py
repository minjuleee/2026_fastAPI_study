# 파일 위치 : astapi_basic/app/routers/llm_router.py
...
# 요청 / 응답 시 처리되는 데이터 검증용
from app.schemas.llm import SummarizeRequest, SummarizeResponse, SentimentReviewRequest, SentimentReviewResponse
...
@llm_router.get("/summarize", response_model=SummarizeResponse, status_code=201, summary="텍스트 요약(LLM)")
